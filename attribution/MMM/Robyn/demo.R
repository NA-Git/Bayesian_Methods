...
OutputModels <- robyn_run(
  ...
  cores = 16, # default to max available
...
print(OutputCollect)
select_model <- "8_99_5" # select one from above
...
# json_file <- "C:/Users/norri/Desktop/Robyn_202208230839_init/RobynModel-3_111_2.json"
